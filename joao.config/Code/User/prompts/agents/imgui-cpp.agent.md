...
The Makefile build uses `-std=c++23 -g -Wall -Wformat` and pkg-config for glfw3, vulkan, freetype2, plutosvg. It also produces a local `compile_commands.json`.
